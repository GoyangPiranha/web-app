...
class admin_user extends CI_Controller {
  ...
  public function prosesTambah() {
        $this->load->model('m_users');
        $this->load->model('m_admin');
        if ($_POST['fullname'] != "" && $_POST['username'] != "" && $_POST['genre'] != "" && $_POST['deskripsi_user'] != ""  && $_FILES['userfile']['name'] != "" && $_POST['dateofbirth'] != ""
           && $_POST['password'] != "" && $_POST['confirmpassword'] != "" && $_POST['city'] != "" && $_POST['address'] != "" && $_POST['email'] != "" && $_POST['handphone'] != ""
            && $_POST['rekening_user'] != "") {
          ...
          if ($user == true) {
            $data = array(
              "warning" => "Username sudah ada, masukkan username lain",
              "page" => "sidemenu.php",
              "content" => "User/user_tambah.php"
            );
            $data['provinsi']=$this->M_users->getProvinsiQuery();
