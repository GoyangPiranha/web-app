<?php
	...
	Class M_transaksi extends CI_Model {
        ...
        function insert($id_transaksi, $id_user, $id_produk, $id_jenis_konveksi, $id_ukuran, $id_status_transaksi, $id_tujuan, $tanggal, $jenis_pengiriman, $harga_pengiriman, $total_harga){

            $query = $this->db->query("INSERT INTO `transaksi`(`id_transaksi`, `id_user`, `id_produk`, `id_jenis_konveksi`, `id_ukuran`, `id_status_transaksi`, `id_tujuan`, `tanggal`, `jenis_pengiriman`, `harga_pengiriman`, `total_harga`) 
            VALUES ($id_transaksi, $id_user, $id_produk, $id_jenis_konveksi, $id_ukuran, $id_status_transaksi, $id_tujuan, $tanggal, $jenis_pengiriman, $harga_pengiriman, $total_harga))");
            if ($query == true) {
				return true;
			}
        }
