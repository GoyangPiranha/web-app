                            ...
                            <table class="table table-hover table-bordered" id="konveksi">
                                ...
                                <?php foreach($produk as $index => $row):?>
                                    <tr>
                                        ...
                                        <th class="text-center"><button onclick="change_status(<?php echo $row->id_produk;?>)" class="btn btn-info btn-flat" style="padding:5px 5px;"><i class="fa fa-sm fa-pencil" ></i></button><button style="padding:5px 5px;" type="button" class="btn btn-flat btn-danger" onclick="hapus(<?php echo $row->id_produk?>)"><span class="fa fa-trash"></span></button></th>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
                            </table>
    ...
    <script type="text/javascript">
        ...
        function hapus(id){
            if(confirm('Apakah anda yakin ingin menghapus user?')){
                ...
                console.log(id)
                $.ajax({
                    url : "<?php echo base_url('Admin_product/deleteProduct');?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
