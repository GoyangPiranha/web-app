...
<body class="sidebar-mini fixed">
                            ...
                            <table class="table table-hover table-bordered" id="konveksi">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php $id = $row->id; $str_id = (string)$id;?>
                                        <!--<td><?php echo $row->logo;?></td>-->
                                        <td class="text-center"><button onclick="updateKonveksi(<?php echo $str_id;?>)" class="btn btn-info btn-flat" style="padding:5px 5px;"><i class="fa fa-sm fa-pencil" ></i></button><a class="btn btn-danger btn-flat show-alert" onclick="hapus(<?php echo $str_id;?>)" style="padding:5px 5px;" href="#"><i class="fa fa-sm fa-trash" ></i></a></td>
                                    </tr>
                                    <?php echo $row->id;?>
                                    <?php endforeach;?>
                                </tbody>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="form" action="<?php echo base_url();?>Admin_konveksi/add" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" name="Tambah" class="btn btn-success" value="Tambah"></input>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function hapus(id){
            if(confirm('Apakah anda yakin ingin menghapus konveksi?')){
                // ajax delete data to database
                console.log(id)
                $.ajax({
                    url : "<?php echo base_url('Admin_konveksi/deleteKonveksi');?>/" + id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
