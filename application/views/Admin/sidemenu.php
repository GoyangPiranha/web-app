  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li >
          <a href="<?php echo base_url()?>index.php/admin_jenis_produk">
            <i class="fa fa-dashboard"></i> <span>Jenis Produk</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        </li>
        <li >
          <a href="<?php echo base_url()?>index.php/admin_kategori_produk">
            <i class="fa fa-dashboard"></i> <span>Kategori Produk</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        </li>
        <li >
        ...
        <li >
          <a href="<?php echo base_url()?>index.php/admin_home">
            <i class="fa fa-dashboard"></i> <span>Ukuran</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        </li>
        <li >
          <a href="<?php echo base_url()?>index.php/admin_home">
        ...
        <li >
          <a href="<?php echo base_url()?>index.php/admin_home">
            <i class="fa fa-dashboard"></i> <span>Logistik</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
        </li>
        <li >
          <a href="<?php echo base_url()?>index.php/admin_home">
