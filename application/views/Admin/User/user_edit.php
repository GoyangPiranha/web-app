                        ...
                        <div class="col-xs-11">
                          <div class="form-group">
                            <div class="input-group">
                              ...
                              <input value="<?php echo $detail['nama_user'] ?>" name="fullname" type="text" class="form-control" placeholder="Nama Lengkap" aria-describedby="basic-addon1">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row"  style="margin-left:10px;">
                        ...
                        <div class="col-xs-11">
                          <div class="form-group">
                            <div class="input-group">
                              <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-user"></span></span>
                              <input value="<?php echo $detail['username_user'] ?>" name="username" type="text" class="form-control" placeholder="Username" aria-describedby="basic-addon1">
                            </div>
                          </div>
                        </div>
                      </div>
