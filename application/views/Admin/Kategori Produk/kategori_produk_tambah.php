        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo base_url('Admin_kategori_produk/prosesTambah'); ?>" class="inner-login" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-xs-11">
                          <div class="form-group">
                              <div class="input-group">
                                  ...
                                  <input name="kategori_produk" type="text" class="form-control" data-role="tagsinput" placeholder="Kategori produk" aria-describedby="basic-addon1">
                              </div>
                          </div>
                      </div>
                    </div>
              ...
              <input name="submit" type="submit" class="btn btn-block btn-primary" value="ADD KATEGORI PRODUK" />
            </form>
          </div>
        </div>
