        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo base_url('Admin_produk/prosesTambah'); ?>" class="inner-login" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                  <div class="col-xs-6">
                      <div class="form-login">
                          <div class="">
                              <img style="position:relative; background: white; height:150px; width: 180px; margin-bottom: 10px; margin-left: 10px; " id="uploadPreviewDepan" width="100" class="text-center" alt="Priview Gambar" />
                          </div>
                      </div>
                  </div>
                  <div class="col-xs-6">
                      <div class="form-login">
                          <div class="">
                              <img  style="position:relative; background: white; height:150px; width: 180px; margin-bottom: 10px; margin-right: 10px;" id="uploadPreviewBelakang" width="100" class="text-center" alt="Preview Gambar" />
                          </div>
                      </div>
                  </div>
              ...
              <input name="submit" type="submit" class="btn btn-block btn-primary" value="ADD PRODUK" />
            </form>
          </div>
        </div>
